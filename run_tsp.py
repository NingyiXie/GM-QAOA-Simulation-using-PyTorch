...
def worker(params):
    sample_gap_approx_opt(params,TASK,get_problem,get_distribtuion_path,distribution_tsp,get_result_path)
    

def main():
    parser = argparse.ArgumentParser(description='run for tsp')
    parser.add_argument('--N', type=str, default='8,9,10,11,12,13', help='nodes')
    ...
    for p in level_list:
        ...
        num_processors = min([16,multiprocessing.cpu_count()])
